    ...
    <form id="form1" runat="server" autocomplete="off">
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style66" style="font-family: 'Tw Cen MT Condensed'"><strong>Middle Initial</strong></td>
                    <td class="auto-style81" style="font-family: 'Tw Cen MT Condensed'">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Middle Initial Required!" ControlToValidate="PatientMiddlenameTextbox" ForeColor="Red"></asp:RequiredFieldValidator>
                    </td>
