            ...
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td class="auto-style17" style="font-family: 'Tw Cen MT Condensed'">
                        ...
                        <asp:Button ID="SearchImmunizationButton" runat="server" Text="Search" CausesValidation="False" OnClick="SearchImmunizationButton_Click" />
                        <asp:RequiredFieldValidator ID="PatientRequiredFieldValidator0" runat="server" ErrorMessage="Immunization No. Required" ForeColor="Red" ControlToValidate="ImmunizationNoTextBox"></asp:RequiredFieldValidator>
                    </td>
                ...
                <tr>
                    ...
                    <td class="auto-style17" style="font-family: 'Tw Cen MT Condensed'">
                        <asp:Label ID="ImmunizedByLabel" runat="server" BackColor="#FFCC99"></asp:Label>
                    </td>
                ...
                <tr>
                    ...
                    <td class="auto-style23" style="font-family: 'Tw Cen MT Condensed'">
                        &nbsp;</td>
                    <td class="auto-style21" style="font-family: 'Tw Cen MT Condensed'">Patient starts at <strong>PAT01</strong></td>
                    <td class="auto-style11" style="font-family: 'Tw Cen MT Condensed'">Vaccine Code starts at <strong>VAX01</strong></td>
                    <td class="auto-style8" style="font-family: 'Tw Cen MT Condensed'">&nbsp;</td>
                    <td class="auto-style7" style="font-family: 'Tw Cen MT Condensed'">&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
