...
namespace Pediatric
{
    public partial class Immunization : System.Web.UI.Page
    {
        ...
        {
            SqlDataAdapter thisDataAdapter = new SqlDataAdapter("SELECT * FROM IMMUNIZATIONHEADERTABLE", connectionString);
        ...
        public void SearchImmunization()
        {
            ...
            if (found == false)
            {
                Response.Write("<script> alert('Immunization number not yet found in the file. Please continue.');</script>");
                ImmunizationNoTextBox.Focus();
            }
        }
