<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Pediatric.Default" %>
        ...
        <div>
            <table class="auto-style1" >
                ...
                <tr>
                    <td class="auto-style6" style="font-family: 'Tw Cen MT Condensed'">&nbsp;</td>
                    <td class="auto-style7" style="font-family: 'Tw Cen MT Condensed'">
                        <asp:LinkButton ID="SignUpLinkButton" runat="server" CausesValidation="False" OnClick="SignUpLinkButton_Click">SignUp</asp:LinkButton>
                    </td>
                    <td class="auto-style8" style="font-family: 'Tw Cen MT Condensed'">
                        &nbsp;</td>
                </tr>
